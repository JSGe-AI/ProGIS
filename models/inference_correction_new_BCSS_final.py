...
def train_model(model, val_loader, epochs=50, threod=0.4, fold=1 , cls_num="1"):
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            # fold_dir = f'/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold}/rebuttal_results_Perturbation' 
            # os.makedirs(fold_dir, exist_ok=True)    
            # filename_iou = f"/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold}/rebuttal_results_Perturbation/iou_{cls_num}_thr{threod}.pkl" #  指定文件名
            # filename_acc = f"/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold}/rebuttal_results_Perturbation/acc_{cls_num}_thr{threod}.pkl" #  指定文件名
            # filename_dice = f"/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold}/rebuttal_results_Perturbation/dice_{cls_num}_thr{threod}.pkl" #  指定文件名
        ...
        # print(f"保真度：Execution time: {elapsed_time:.4f} seconds")
        
        return val_dice_score[24], mean_IoU[24], val_accuracy[24]
...
for fold_num in fold_list:
    ...
    ckpt = f'/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold_num}/ckpt/cos2_BCSS_resunet_best.pth'
    # 去除 'module.' 前缀
    ...
    for a in range(1):
        ...
        for cls in choices:
            ...
            # val_images_dir = f"/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold_num}/train/{cls}/image_npy"
            # val_masks_dir = f"/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold_num}/train/{cls}/mask_npy"
            # val_signal_dir = f'/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold_num}/train/{cls}/signal_max_point_npy'
            # val_superpixel_dir = f'/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_{fold_num}/train/{cls}/image_SLIC_500'
            
            path = '/data_nas2/gjs/ISF_pixel_level_data/BCSS_x10_reinhard_cut/125WSI/fold_1/user_study/TCGA-A2-A3XX-DX1_xmin69942_medium'
            
            val_images_dir = f"{path}/image_npy"
            val_masks_dir = f"{path}/mask_npy"
            val_signal_dir = f'{path}/signal_max_point_npy'
            val_superpixel_dir = f'{path}/image_SLIC_500'
