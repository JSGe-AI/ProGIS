...
# 创建模型实例
model = get_efficientunet_b4(out_channels=1, concat_input=True, pretrained=False).cuda()
...
def train_model(model, train_loader, val_loader, loss_fn, optimizer,  epochs=50):
    ...
    for epoch in range(epochs):
        ...
        if dice_score > best_dice:
            ...
            torch.save(model.state_dict(), '/home/gjs/ISF_nuclick/checkpoints_new/efficient_Unet_512/efficient_Unet_512_filling_test.pth')
